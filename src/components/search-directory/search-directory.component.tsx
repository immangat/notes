...
import {CreateNoteGridItem, DirectoryContainer, NotesContainer, NotesGridItem, NotesItem} from '../directory/directory.styles'
...
const SearchDirectory = (props: SearchDirectoryType) => {
    ...
    const {getNotes, addNote, deleteNote} = useContext(NotesContext)
